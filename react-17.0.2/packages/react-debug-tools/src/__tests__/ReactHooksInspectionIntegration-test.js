      ...
      expect(tree).toEqual([
        {
          ...
          id: null,
          name: 'LabeledValue',
          value: false ? 'custom label a' : undefined,
          subHooks: [
            {
              isStateEditable: true,
              id: 0,
        ...
        },
        {
          ...
          id: null,
          name: 'LabeledValue',
          value: false ? 'custom label d' : undefined,
          subHooks: [
            {
              isStateEditable: true,
              id: 3,
      ...
      expect(tree).toEqual([
        {
          ...
          id: null,
          name: 'Outer',
          value: false ? 'outer' : undefined,
          subHooks: [
            {
              isStateEditable: false,
              id: null,
              name: 'Inner',
              value: false ? 'inner' : undefined,
              subHooks: [
                {
                  isStateEditable: true,
                  id: 0,
      ...
      expect(tree).toEqual([
        {
          ...
          value: false ? 'single one' : undefined,
          subHooks: [
            {
              isStateEditable: true,
              id: 0,
        ...
        },
        {
          ...
          value: false ? ['one', 'two', 'three'] : undefined,
          subHooks: [
            {
              isStateEditable: true,
              id: 1,
        ...
        },
        {
          ...
          id: null,
          name: 'SingleLabelCustom',
          value: false ? 'single two' : undefined,
          subHooks: [
            {
              isStateEditable: true,
              id: 2,
