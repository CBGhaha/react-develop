...
export function injectIntoDevTools(devToolsConfig: DevToolsConfig): boolean {
  ...
  return injectInternals({
    ...
    // React Refresh
    findHostInstancesForRefresh: false ? findHostInstancesForRefresh : null,
    scheduleRefresh: false ? scheduleRefresh : null,
    scheduleRoot: false ? scheduleRoot : null,
    setRefreshHandler: false ? setRefreshHandler : null,
    // Enables DevTools to append owner stacks to error messages in DEV mode.
    getCurrentFiber: false ? getCurrentFiberForDevTools : null,
  });
}
